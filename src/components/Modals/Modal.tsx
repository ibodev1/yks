...
const Modal: Component<{
  ...
  return (
    <div class="fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 bg-vanilla min-w-[25rem] max-w-screen-[25rem] max-h-[75%] overflow-y-auto rounded-lg z-[999] shadow-lg">
